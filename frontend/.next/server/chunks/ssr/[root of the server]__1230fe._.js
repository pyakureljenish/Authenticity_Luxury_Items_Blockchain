...
"[project]/utils/contract.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module './MyNFTMarketplaceABI.json'");
...
function getContract(provider) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(CONTRACT_ADDRESS, MyNFTMarketplaceABI, provider);
}
function getSignedContract(signer) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(CONTRACT_ADDRESS, MyNFTMarketplaceABI, signer);
}
}}),
"[project]/contexts/Web3Context.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$contract$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/contract.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__ = __turbopack_import__("[project]/node_modules/ethers/lib.esm/ethers.js [app-ssr] (ecmascript) <export * as ethers>");
"use client";
;
;
    ...
    const connect = async ()=>{
        ...
        try {
            ...
            if (accounts && Array.isArray(accounts)) {
                ...
                setSigner(newSigner);
                setContract((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$contract$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSignedContract"])(newSigner));
                setIsConnected(true);
            }
        } catch (error) {
...
const Navbar = ()=>{
    ...
    const { connect, connecting, isConnected, account } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$Web3Context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWeb3"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setIsMounted(true);
        const handleScroll = ()=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1230fe._.js.map