(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_7a753d._.js", {
...
;
;
const CONTRACT_ADDRESS = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_CONTRACT_ADDRESS || "";
function getContract(provider) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(CONTRACT_ADDRESS, MyNFTMarketplaceABI, provider);
}
function getSignedContract(signer) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(CONTRACT_ADDRESS, MyNFTMarketplaceABI, signer);
}
    ...
    const connect = async ()=>{
        ...
        try {
            ...
            if (accounts && Array.isArray(accounts)) {
                ...
                setSigner(newSigner);
                setContract((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$contract$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSignedContract"])(newSigner));
                setIsConnected(true);
            }
        } catch (error) {
...
//# sourceMappingURL=_7a753d._.js.map